...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="" method="post">
			...
			<button type="submit" name="subm">Daftar</button>
		</form>
	</div>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				...
				<p>Untuk tetap terhubung dengan kami, Silahkan daftar dengan informasi pribadi</p>
				<button class="ghost" id="signIn">Log In</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Selamat datang</h1>
				<p>Masukkan username dan password anda untuk mulai mencari tahu tentang kami</p>
...
<?php
    if(isset($_POST['subm'])){
        ...
        ("'.addslashes($_POST['username']).'", "'.md5($_POST['password']).'")';
